...
using SP_DEVICE_INTERFACE_DATA = quadrotor_groundstation.WindowsAPI.SP_DEVICE_INTERFACE_DATA;
using SP_DEVICE_INTERFACE_DETAIL_DATA = quadrotor_groundstation.WindowsAPI.SP_DEVICE_INTERFACE_DETAIL_DATA;
    ...
    public class USBHID
    {
        ...
        private void GetDeviceList(ref List<string> deviceList)
        {
            ...
            if (HIDInfoSet != IntPtr.Zero)
            {
                ...
                for (uint index = 0; index < MAX_USB_DEVICES; index++)
                {
                    ...
                    detail.cbSize = Marshal.SizeOf(typeof(quadrotor_groundstation.WindowsAPI.SP_DEVICE_INTERFACE_DETAIL_DATA));
        ...
        internal string WriteUSBHID(string sendValue)
        {
            try
            {
                ...
                hidDevice.Write(array, 0, array.Length);
                return sendValue;
            }
            catch (Exception e)
            {
